...
public class Main {
    public static void main(String[] args) {
        ...
        TransporteAlimentos transporteAlimentos = new TransporteAlimentos("AF 373 EQ", "Transporte de alimentos para la empresa Alimentos Modernos S.A", "Buenos Aires", "Rosario", alimentos);
